...
class CrawledUrl(Base):
    ...
    title_length: Mapped[Optional[int]] = mapped_column(sa.SmallInteger(), nullable=True)
    title_pixel_width: Mapped[Optional[int]] = mapped_column(sa.SmallInteger(), nullable=True)
